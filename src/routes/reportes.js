...
router.get('/ventas-por-categoria', authMiddleware, checkPermission('reports', 'view'), obtenerVentasPorCategoria);
router.get('/gastos', authMiddleware, checkPermission('reports', 'view'), obtenerReporteGastos);
